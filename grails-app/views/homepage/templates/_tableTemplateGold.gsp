...
<table style="width:1024px;" cellpadding="0" cellspacing="0">
    <tr>
        <td colspan="2" style="background-color:#FFA500;" >
            <table style="width:1024px;"  cellpadding="0" cellspacing="0" background="${request.contextPath}/content/images/banners/gold720x220.jpg">
                <tr>
                    <td align="center">
    ...
    <tr>
        <td colspan="2" >
            <table style="width:1024px;" style="height:90px"  cellpadding="0" cellspacing="0" background="${request.contextPath}/content/images/banners/gold720x90.jpg">
                <tr>
